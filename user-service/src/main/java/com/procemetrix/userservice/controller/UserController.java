package com.procemetrix.userservice.controller;

import com.procemetrix.userservice.entity.User;
import com.procemetrix.userservice.model.Bike;
import com.procemetrix.userservice.model.Car;
import com.procemetrix.userservice.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<Car> fallBackSaveCars(@PathVariable("userId") int userId, @RequestBody Car car, RuntimeException e) {
    ...
    public ResponseEntity<Bike> fallBackSaveBikes(@PathVariable("userId") int userId, @RequestBody Bike bike, RuntimeException e) {
